...
# alignment lines: black blue brown green lt_green */
my @rlincol=(0.0, 0.0, 0.6, 0.45, 0.0);
my @glincol=(0.0, 0.0, 0.8, 0.30, 1.0);
my @blincol=(0.0, 0.8, 1.0, 0.15, 0.0);
